    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress_rencana', models.IntegerField(blank=True, null=True, verbose_name='Progress Rencana')),
                ('progress_aktual', models.IntegerField(blank=True, null=True, verbose_name='Progress Aktual')),
                ('bcws', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True, verbose_name='Budgeted Cost of Work Schedule')),
                ('bcwp', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True, verbose_name='Budgeted Cost of Work Planned ')),
                ('acwp', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True, verbose_name='Actual Cost of Work Planned')),
