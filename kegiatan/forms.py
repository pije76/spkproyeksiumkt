...
class Kegiatan_ModelForm(forms.ModelForm):
	...
	biaya_kegiatan = forms.FloatField(required=False, label="Biaya Kegiatan:", max_value=1000000000, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control', 'step': "1.00"}))
...
class Schedule_ModelForm(forms.ModelForm):
	...
	progress_rencana = forms.FloatField(required=False, label="Progress Rencana:", max_value=100, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control', 'step': "0.1"}))
	progress_aktual = forms.FloatField(required=False, label="Progress Aktual:", max_value=100, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control', 'step': "0.1"}))
